  ...
  <body>
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div>
          <p> <strong>SEGUNDA:</strong> Propuesta de Inversión. La propuesta de inversión, el porcentaje estimado de rentabilidad y el riesgo asociado a la operación financiera, identifica el mejor y el peor escenario para la decisión de inversión, según como aparece en la siguiente tabla:</p>
        </div>
        <br>
      ...
      <div class="page_break">
        <p><strong>TERCERA: </strong>Mecánica de la Operación: EL OTORGANTE  <strong> <span>(Operador)</span></strong> recibe el capital de LOS BENEFICIARIOS <strong> <span>(Inversores)</span></strong>  y realiza operaciones financieras en la bolsa de valores con el fin de proteger el capital del cliente.</p>
      </div>
      ...
      <div>
        <p>
          <strong >SÉPTIMA:</strong> Retiros de Capital. LOS BENEFICIARIOS<strong> <span>(Inversores)</span></strong> deberán dar aviso al OTORGANTE (Operador) en caso de retiro parcial o total del capital entregado, con un mínimo de anticipación de    30 días calendario en cuyo mes no se generará la rentabilidad acordada, y en su lugar se les reconocerá a LOS BENEFICIARIOS al menos el valor equivalente a la inflación aprobada por el gobierno nacional para dicho mes, con el propósito de no ver afectado su poder adquisitivo.
        </p>
      </div>

      <div >
        <p>
          <strong>OCTAVA:</strong> Incrementos de Capital. En cualquier momento y durante la vigencia del presente pagaré, LOS BENEFICIARIOS pueden incrementar el valor de su inversión en cualquier monto, sin límites ni restricciones, y el capital adicional estará cobijado por las mismas condiciones pactadas inicialmente en este acuerdo.
        </p>
      </div>
      <div>
        <p>
          <strong>NOVENA:</strong> Extractos y Pagos. El extracto resumen de la operación se generará y pondrá en conocimiento de LOS BENEFICIARIOS el día primero (1º.) de cada mes y el dinero rentado durante el mes, se consignará a más tardar el día diez (10) de cada mes.
        </p>
      </div>

      <div>
        <p>
          <strong>DÉCIMA:</strong> Formas de pago. La consignación mensual del valor rentado a LOS BENEFICIARIOS, se hará mediante transferencia bancaria a la cuenta personal de uno (1) solo de ellos. O si se requiere por parte del inversionista se podrá cancelar en efectivo asumiendo el 4X1000.
        </p>
      </div>

      <div>
        <p>
          <strong>DÉCIMA PRIMERA:</strong> Vigencia. El acuerdo descrito por las partes, empezará a regir desde el FECHA EN LETRAS <strong> <span>(FECHA EN NÚMEROS)</span></strong> de MES de AÑO y terminará FECHA EN LETRAS  <strong> <span> (FECHA EN NÚMEROS)</span></strong> de MES de AÑO, es decir, tendrá una duración de un (1) año, pudiendo ser renovado a través de un nuevo acuerdo escrito entre las partes o finalizado antes Del año, por acuerdo explícito entre las partes, sin que esto constituya perjuicios para las mismas. En ningún caso tendrá renovación automática.
        </p>
      </div>

      <div>
        <p>
          <strong>DÉCIMA SEGUNDA:</strong> Normatividad. El presente documento está amparado por la normatividad vigente sobre lo concerniente a los títulos valores, en especial por el artículo 709 del Código de Comercio y demás normas concordantes sobre la materia.
        </p>
      </div>

      <div>
        <p>
          En constancia y aprobación del contenido del presente documento, firman las partes, en la ciudad de Bucaramanga a FECHA EN LETRAS <strong> <span>(FECHA EN NÚMEROS)</span></strong>  de MES de AÑO.
        </p>
      </div>
